  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center bg-gray-100 pb-4">
        <div className="container flex-col items-center justify-center p-[20px]">
          {/* <!-- Payment options --> */}
          <a href="#" className="flex w-full items-center gap-2 text-[.8rem]">
            <img
          ...
          {/* <!-- Social media --> */}
          <div className="flex w-full items-center gap-2 border-b-[1px] border-gray-200 pb-4">
            <a href="" className="">
              <img
          ...
          <div className="flex w-full flex-wrap gap-8">
            ...
            <div className="flex min-w-[150px] basis-[20%] flex-col">
              ...
              <div className="mt-[10px] text-[.8rem]">
            ...
            <div className="flex flex-col">
              <h1 className="text-[.9rem] font-semibold uppercase">LIÊN HỆ</h1>
              <div className="mt-[10px] text-[.8rem]">
